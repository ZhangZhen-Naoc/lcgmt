...
Revision ID: 1c44a104a541
Revises: 2546a7c6b70b
Create Date: 2023-10-25 14:41:14.380487
...
revision = '1c44a104a541'
down_revision = '2546a7c6b70b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('fxt_source_observation', sa.Column('type', sa.String(length=20), nullable=True), schema='tdic')
