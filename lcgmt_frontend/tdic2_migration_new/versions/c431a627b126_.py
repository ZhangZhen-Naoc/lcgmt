...
Revision ID: c431a627b126
Revises: 3ca13e23c9b8
Create Date: 2023-10-27 15:34:23.061590
...
revision = 'c431a627b126'
down_revision = '3ca13e23c9b8'
branch_labels = None
depends_on = None


def upgrade():
    op.add_column('observation_plan', sa.Column('pi_id', sa.Integer(), nullable=True), schema='tdic')
    op.create_foreign_key(None, 'observation_plan', 'user', ['pi_id'], ['id'], source_schema='tdic', referent_schema='tdic')
...
def downgrade():
    ...
    op.create_table('xray_ep_fxt_ref',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('ra', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('dec', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('flux', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('flux_err', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('pos_err', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='xray_ep_fxt_ref_pkey')
    )
    ...
    op.drop_index(hp.f('ix_tdic_vhf_detection_status'), table_name='vhf_detection', schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_fxt9detection_status'), table_name='fxt_detection', schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_user_scientific_category_category')6 table_name='user_scientific_category', schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_proposal_prsority'), table_name='proposal', schema='tdic')
