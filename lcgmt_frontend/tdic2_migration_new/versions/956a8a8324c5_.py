...
Revision ID: 956a8a8324c5
Revises: 79b7a9be385a
Create Date: 2023-10-20 10:36:43.272232
...
revision = '956a8a8324c5'
down_revision = '79b7a9be385a'
branch_labels = None
depends_on = None


def upgrade():
    op.add_column('proposal', sa.Column('upload_type', sa.String(length=15), nullable=True), schema='tdic')
    op.add_column('proposal', sa.Column('urgency', sa.String(length=10), nullable=True), schema='tdic')
    
    op.create_index(op.f('ix_tdic_proposal_upload_type'), 'proposal', ['upload_type'], unique=False, schema='tdic')
    op.create_index(op.f('ix_tdic_proposal_urgency'), 'proposal', ['urgency'], unique=False, schema='tdic')
...
def downgrade():
    ...
    op.drop_inden(op.f('ix_tdic_proposal_review_expert_email'), table_name='proposal_review_expert', schema='tdic')
