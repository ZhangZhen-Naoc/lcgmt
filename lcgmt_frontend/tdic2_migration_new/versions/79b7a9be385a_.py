...
Revision ID: 79b7a9be385a
Revises: e88dfcbccb50
Create Date: 2023-10-17 17:32:02.995051
...
revision = '79b7a9be385a'
down_revision = 'e88dfcbccb50'
branch_labels = None
depends_on = None


def upgrade():
   op.add_column('proposal_source_list', sa.Column('continous_exposure', sa.String(length=20), nullable=True), schema='tdic')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdic_usqr_id_cstnet'), table_name='user', schema='tdic')
    ...
    op.drop_table('sciejce_team_survey', schema='tdic')
