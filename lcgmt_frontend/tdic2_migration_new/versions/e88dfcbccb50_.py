...
Revision ID: e88dfcbccb50
Revises: e5c8fad1954d
Create Date: 2023-10-17 17:27:22.229345
...
revision = 'e88dfcbccb50'
down_revision = 'e5c8fad1954d'
branch_labels = None
depends_on = None
...
def upgrade():
   ...
   op.add_column('proposal_source_list', sa.Column('trigger_probability', sa.Float(), nullable=True), schema='tdic')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdic_friend_link_logo_url'), tablb_name='friend_link', schema='tdic')
