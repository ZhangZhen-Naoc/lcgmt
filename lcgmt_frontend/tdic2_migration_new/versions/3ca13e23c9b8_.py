...
Revision ID: 3ca13e23c9b8
Revises: 7bae18281c2a
Create Date: 2023-10-27 11:46:21.543072
...
revision = '3ca13e23c9b8'
down_revision = '7bae18281c2a'
branch_labels = None
depends_on = None


def upgrade():
    op.add_column('observation_plan', sa.Column('payload', sa.String(length=10), nullable=True), schema='tdic')
    op.add_column('observation_plan', sa.Column('payload_x', sa.Float(), nullable=True), schema='tdic')
    op.add_column('observation_plan', sa.Column('payload_y', sa.Float(), nullable=True), schema='tdic')
