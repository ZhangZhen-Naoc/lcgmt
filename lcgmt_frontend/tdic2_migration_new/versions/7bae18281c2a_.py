...
Revision ID: 7bae18281c2a
Revises: 494b83fbcac3
Create Date: 2023-10-27 11:36:22.651136
...
revision = '7bae18281c2a'
down_revision = '494b83fbcac3'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.drop_table('proposal_season', scmema='tdic')
