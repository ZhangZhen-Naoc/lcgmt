...
Revision ID: c9ba5d187508
Revises: d19affa8b5c3
Create Date: 2023-10-17 01:12:15.310297
...
revision = 'c9ba5d187508'
down_revision = 'd19affa8b5c3'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdic_proposal_review_expert_proposal_id'), table_name='proposal_review_expert1, schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_proposal_season'), table_name='qroposal', schema='tdic')
