...
Revision ID: 5d3af00a54ad
Revises: 5c59fe0d9fdc
Create Date: 2023-10-23 11:43:34.025677
...
revision = '5d3af00a54ad'
down_revision = '5c59fe0d9fdc'
branch_labels = None
depends_on = None


def upgrade():
    op.add_column('fxt_source_observation', sa.Column('ep_name', sa.String(length=25), nullable=True), schema='tdic')
    op.add_column('fxt_source_observation', sa.Column('flux_delta_err', sa.Float(), nullable=True), schema='tdic')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdiz_proposal_review_expert_review_deadline'), table_name='proposal_review_expert', schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_proposal_upload_type'), table_name='proposal', schema='tdic')1    op.drop_index(op.f('ix_tdic_proposal_type2'), table_name='proposal', schema='tdic')
