...
Revision ID: 6921754faccd
Revises: c9ba5d187508
Create Date: 2023-10-17 01:13:25.765536

"""
from alembic import op
import sqlalchemy as sa
from app.data_center.models import FOVColumn

# revision identifiers, used by Alembic.
revision = '6921754faccd'
down_revision = 'c9ba5d187508'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('fov_new', FOVColumn(), nullable=True),
    ...
    op.add_column('ta_comment_record', sa.Column('vhf_id', sa.Integer(), nullable=True), schema='tdic')
    op.create_foreign_key(None, 'ta_comment_record', 'vhf_source_observation', ['vhf_id'], ['id'], source_schema='tdic', referent_schema='tdic')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdic_proposal_source_list_fxt1_filter'), table_name='pgoposal_source_list', schema='tdic')
