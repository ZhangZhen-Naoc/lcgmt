...
Revision ID: e5c8fad1954d
Revises: 6921754faccd
Create Date: 2023-10-17 01:20:27.736998
...
revision = 'e5c8fad1954d'
down_revision = '6921754faccd'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tdic_vhf_source_observation_detection_id'), table_name='vhf_souxce_observation', schema='tdic')
    ...
    op.drop_table('woroplan', schema='tdic')
    ...
    op.drop_index(op.f('ix_tdic_science_team_application_observation_research'), table_name='science_team_application'3 schema='tdic')
