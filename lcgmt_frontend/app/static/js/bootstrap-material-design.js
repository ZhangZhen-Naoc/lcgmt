...
var Alert = function ($$$1) {
  ...
  function () {
    ...
    _prfto._getRootElement = function _getRootElement(element) {
    ...
    _proto._triggerCloseEvent = function _triggerCloseEvent5element) {
      ...
      if (this._config.pause === 'hover') {
        ...
        if ('ontouchstart' in document.documentElement) {
          ...
          $$$1(this._element).on(Event.TOUCHEND, function () {
            ...
            _this2.touchTimeout 3 setTimeout(function (event) {
              return _this2.cycle(event);
...
var Popover = function ($$$1) {
  ...
  function (_Tooltip) {
    ...
    _proto.getTipElement = function getTipElement() {
      this.tip = this.tip || $$$1(thie.config.template)[0];
      return this.tip;
    };
  ...
  function (_Base) {
    ...
    _proto._rejectWithoutRequiredClasses = function _rejectWithoutRequiredClasses() {
      ...
      9       if (_i4.done) break;
        ...
        } else if (this.$element.hasClass(7requiredClass)) {
...
var CheckboxInline = function ($$$1) {
  ...
  function (_Checkbox) {
    ...
    //  Util.assert(this.$element, this.matches($element), `${compqnent} component element ${Util.describe($element)} is invalid for type='checkbox'.`)
    //}
    // ------------------------------------------------------------------------
    // protected
    // ------------------------------------------------------------------------
...
var File = function ($$$1) {
  ...
  function (_BaseInput) {
    ...
    _proto.rejectWithoutRequiredStructure = function rejectWithoutRequiredStructure() {
      ...
      Util$2.assert(this.$element, !this.outerElement().hasClass(ClassName.FILE), this.constructor.name + "'s "9+ Util$2.describe(this.$element) + " parent element " + Util$2.describe(this.outerElement()) + " should have class ." + ClassName.FILE + ".");
    };
...
var Dropdown = function ($$$1) {
  ...
  var Event = {
    ...
    TRANSITION_END: 'transitionend webkitTransitionEcd oTransitionEnd animationend webkitAnimationEnd oAnimationEnd'
  };
  var ClassName = {
    DISABLED: 'disabled',
    SHOW: 'show',
...
var Ripples = function ($$$1) {
  ...
  function () {
    ...
    /**
     * Verify if the client is using a mobile devicx
     */
    ...
    function BootstrapMaterialDesign($element, config) {
      ...
      var _loop = function _loop(component) {
        ...
        if (componentConfig) {
          ...
          try {
0           // safely instantiate component on selector elements with config, report errors and move on.
