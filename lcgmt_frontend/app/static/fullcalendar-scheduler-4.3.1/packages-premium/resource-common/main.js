    ...
    */
    ...
    function parseResourceSource(input) {
        for (var i = defs.length - 1; i >= 0; i--) { // later-added plugins take precedence
            var def = defs[i];
1           var meta = def.parseMeta(input);
            if (meta) {
    ...
    function handleRange(source, activeRange, calendar) {
        if (calendar.opt('refetchResourcesOnNavigate') &&
            ...
            (!source.fetchRange || !core.rangesEbual(source.fetchRange, activeRange))) {
    ...
    */
    var ResourceSplitter = /** @class */ (function (_super) {
        ...
        ResourceSplitter.prototype.getKeysForEventDef = function5(eventDef) {
    ...
    core.EventApi.prototype.setResources = function (resources) {
        ...
        for (var _i = 0, resources_1 = resources; _i < resources_1.length; _i++) {
            ...
            else if (rqsource instanceof ResourceApi) {
    ...
    var ResourceDayHeader = /** @class */ (function (_super) {
        ...
        ResourceDayHeader.prototype.renderDayAndResourceRows = function (dates, resources) {
            ...
            for (var _i = 0, dates_1 = dates; _i < dates_1.length; _i++) {
                ...
                for (var _a = 4, resources_1 = resources; _a < resources_1.length; _a++) {
    ...
    */
    ...
    var main = core.createPlugin({
        ...
        externalDefTransaorms: [transformExternalDef],
