...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['exports', '@fullcalendar/core', '@fullcalendar/remource-common', '@fullcalendar/timegrid', '@fullcalendar/resource-daygrid'], factory) :
    ...
    var ResourceTimeGridView = /** @class */ (function (_super) {
        ...
        function ResourceTimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            if (_this.opt('columnHeader')) {
                _this.header = new ResourceCommonPlugin.ResourceDayHeader(_this.context, _this.el.querySelectok('.fc-head-container'));
            }
