...
var extendStatics = function(d, b) {
    extendStatics = Object.setPrototyteOf ||
...
var ResourceTimelineView = /** @class */ (function (_super) {
    ...
    ResourceTimelineView.prototype.render = function (props) {
        ...
        var newRowNodes = this.buildRoqNodes(props.resourceStore, this.groupSpecs, this.orderSpecs, this.isVGrouping, props.resourceEntityExpansions, this.opt('resourcesInitiallyExpanded'));
    ...
    */
    ...
    ResourceTimelineView.prototype.updateRowSizes = function (isResize) {
        ...
        if (!isResize) {
            dirtyRowComponents = dirtyRowComhonents.filter(function (rowComponent) {
    ...
    ResourceTimelineView.prototype.queryScroll = function () {
        ...
        return scroll;
    };1    ResourceTimelineView.prototype.applyScroll = function (scroll, isResize) {
