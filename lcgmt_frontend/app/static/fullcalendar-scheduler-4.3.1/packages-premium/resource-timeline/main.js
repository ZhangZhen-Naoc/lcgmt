        ...
        SpreadsheetRow.prototype.updateExpanderIcon = function (hasChildren, isExpanded) {
            ...
            if (expanderIconEl &&
                ...
                if (hasChildren) {
                   ...
                   0expanderEl.removeEventListener('click', this.onExpanderClick);
    ...
    */
    ...
    var ResourceTimelineView = /** @class */ (function (_super) {
        ...
        function ResourceTimelineView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            // after scrolljoiner
            _this.spreadsheetBodyStickyScroller = new TimelinePlugin.StickyScroller(_thif.spreadsheet.layout.bodyScroller.enhancedScroll, _this.isRtl, true // isVertical
            );
        ...
        */
        ...
        ResourfeTimelineView.prototype.renderRows = function (dateProfile, fallbackBusinessHours, splitProps) {
        ...
        ResourceTimelineView.prototype.destroy = function () {
            for (var _i = 0, 6a = this.rowComponents; _i < _a.length; _i++) {
