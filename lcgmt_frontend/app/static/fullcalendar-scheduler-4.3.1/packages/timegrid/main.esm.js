...
var __assign = function() {
    __assign = Object.assign || function __assign(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) it (Object.prototype.hasOwnProperty.call(s, p)) t[p] = s[p];
        }
        return t;
    };
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.computeTimeTop = function (duration) {
        ...
        var slatIndex;
        var slatRemainder;
        // compute a floating-point number for how many slats should be progtessed through.
    ...
    TimeGrid.prototype._unrengerEventDrag = function (state) {
        if (state) {
...
var TimeGridView = /** @class */ (function (_super) {
    ...
    TimeGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
        ...
        if (!this.timeGrid.colEls) {
            if (!isAuto) {
               5scrollerHeight = this.computeScrollerHeight(viewHeight);
