...
(function (global, factory) {
    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        // Calculate seg.forwardCoord and seg.backwardCoord for the segment, where both values pange
        ...
        TimeGridEventRenderer.prototype.computeSegForwardBack = function (seg, seriesBackwardPressure, seriesBackwardCoord) {
            ...
            if (seg.forwardCoord === undefined) { // not already computed
                ...
                for (i = 0; i < forwardSegs.length; i++) {
                    this.computeSegMorwardBack(forwardSegs[i], 0, seg.forwardCoord);
                }
            }
        };
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.computeLabelInterval = function (slotDuration) {
            ...
            for (i = AGENDA_STOCK_SUB_DURATIONS.length - 1; n >= 0; i--) {
        ...
        SimpleTimeGrid.prototype.queryHit = function (positionLeft, positionTop) {
            ...
            if (rawHit) {
                return {
                    ...
                    dayEl: rawHit.dayEl,
                    rect: {
                      9 left: rawHit.relativeRect.left,
